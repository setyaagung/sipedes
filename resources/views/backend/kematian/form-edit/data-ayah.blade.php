...
<div class="form-group">
    ...
    <input type="text" name="tanggal_lahir_ayah" class="form-control" value="{{ $ayah->tanggal_lahir}}" readonly>
</div>

<div class="form-group">
    <label for="">Pekerjaan</label>
    <input type="text" name="pekerjaan_ayah" class="form-control" value="{{ $ayah->pekerjaan}}" readonly>
</div>
