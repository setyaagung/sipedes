...
<div class="form-group">
    <label for="">RT</label>
    <input type="number" class="form-control @error('rt') is-invalid @enderror" name="rt" value="{{ old('rt') }}" required placeholder="ex: 04">
    @error('rt')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group">
    <label for="">RW</label>
    <input type="number" class="form-control @error('rw') is-invalid @enderror" name="rw" value="{{ old('rw') }}" required placeholder="ex: 04">
    @error('rw')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
