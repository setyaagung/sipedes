                    ...
                    <div class="card-body">
                        <form action="{{ route('pekerjaan.store')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_pekerjaan" type="text" class="form-control @error('nama_pekerjaan') is-invalid @enderror" name="nama_pekerjaan" value="{{ old('nama_pekerjaan') }}" required autocomplete="name" autofocus>
